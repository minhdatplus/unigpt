...
export default function RightPanel() {
  ...
  return (
    <>
      ...
      <div className={`w-64 bg-white border-l border-gray-200 flex flex-col h-screen fixed right-0 top-0 overflow-hidden transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-full'} md:translate-x-0`}>
        <div className="p-4">
